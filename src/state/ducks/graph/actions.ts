...
export const chartUpdated = (updateTime: number, x: number[], chartLeft: number[], chartRight: number[]) => {
    return action(GraphActionTypes.CHART_UPDATED, { updateTime, x,  chartLeft, chartRight });
}
